if shared.VapeExecuted then
	local VERSION = "5.10"..(shared.VapePrivate and " PRIVATE" or "").." "..readfile("flava/commithash.txt"):sub(1, 6)
	...
	local vapeAssetTable = {
		...
		["flavaassets/VapeIcon.png"] = "rbxassetid://13350808582",
		["flavaassets/RenderIcon.png"] = "rbxassetid://13350832775",
		["flavaassets/VapeLogo1.png"] = "rbxassetid://13350860863",
		["flavaassets/VapeLogo3.png"] = "rbxassetid://13350872035",
		["flavaassets/VapeLogo2.png"] = "rbxassetid://13350876307",
		["flavaassets/VapeLogo4.png"] = "rbxassetid://13350877564"
	}
	...
	local function downloadVapeAsset(path)
		if customassetcheck then
			if not isfile(path) then
				...
				local suc, req = pcall(function() return vapeGithubRequest(path:gsub("flavaassets", "assets")) end)
				if suc and req then
					writefile(path, req)
				else
					return ""
	...
	searchbaricon.Image = downloadVapeAsset("flavaassets/SearchBarIcon.png")
	...
	searchbarshadow.Image = downloadVapeAsset("flavaassets/WindowBlur.png")
	...
	searchbaricon2.Image = downloadVapeAsset("flavaassets/LegitModeIcon.png")
	...
	LegitModulesExitButton.Image = downloadVapeAsset("flavaassets/ExitIcon1.png")
	...
	LegitModulesFrameShadow.Image = downloadVapeAsset("flavaassets/WindowBlur.png")
	...
	LegitModulesFrameIcon.Image = downloadVapeAsset("flavaassets/ProfilesIcon.png")
	...
	hoverboxshadow.Image = downloadVapeAsset("flavaassets/WindowBlur.png")
	...
	GuiLibrary.LoadSettings = function(customprofile)
		if isfile("flavaProfiles/GUIPositions.vapeprofile.txt") and game.GameId == 2619619496 then
			writefile("flavaProfiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("flavaProfiles/GUIPositions.vapeprofile.txt"))
			if delfile then delfile("flavaProfiles/GUIPositions.vapeprofile.txt") end
		end
		if shared.VapePrivate then
			if isfile("vapeprivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") == false and isfile("flavaProfiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") then
				writefile("vapeprivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("flavaProfiles/"..(game.GameId).."GUIPositions.vapeprofile.txt"))
			end
			if isfile("vapeprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") == false and isfile("flavaProfiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") then
				writefile("vapeprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt", readfile("flavaProfiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt"))
			end
		end
		...
		if shared.VapePrivate then
			if isfile("vapeprivate/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") == false and isfile("flavaProfiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") then
				writefile("vapeprivate/Profiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt", readfile("flavaProfiles/"..(GuiLibrary.CurrentProfile == "default" and "" or GuiLibrary.CurrentProfile)..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt"))
			end
		end
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		windowshadow.Image = downloadVapeAsset("flavaassets/WindowBlur.png")
		...
		windowlogo1.Image = downloadVapeAsset("flavaassets/VapeLogo1.png")
		...
		windowlogo2.Image = downloadVapeAsset("flavaassets/VapeLogo2.png")
		...
		settingswheel.Image = downloadVapeAsset("flavaassets/SettingsWheel1.png")
		...
		discordbutton.Image = downloadVapeAsset("flavaassets/DiscordIcon.png")
		...
		settingsexit.Image = downloadVapeAsset("flavaassets/ExitIcon1.png")
		...
		overlaysicon.Image = downloadVapeAsset("flavaassets/TextGUIIcon4.png")
		...
		overlaysexit.Image = downloadVapeAsset("flavaassets/ExitIcon1.png")
		...
		overlaysbutton.Image = downloadVapeAsset("flavaassets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = downloadVapeAsset("flavaassets/BackIcon.png")
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = downloadVapeAsset("flavaassets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = downloadVapeAsset("flavaassets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = downloadVapeAsset("flavaassets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = downloadVapeAsset("flavaassets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindimg.Image = downloadVapeAsset("flavaassets/KeybindIcon.png")
			...
			bindtext2.Image = downloadVapeAsset("flavaassets/BindBackground.png")
			...
			bindbkg.MouseEnter:Connect(function()
				bindimg.Image = downloadVapeAsset("flavaassets/PencilIcon.png")
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = downloadVapeAsset("flavaassets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = downloadVapeAsset("flavaassets/ColorSlider1.png")
			...
			sliderexpand.Image = downloadVapeAsset("flavaassets/HoverArrow3.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = downloadVapeAsset("flavaassets/HoverArrow4.png")
			end)
			...
			sliderapi["SetValue"] = function(hue, sat, val)
				...
				sat = sat or 0.96
				val = val or 0.52
				slider3.Image = ((sliderapi["RainbowValue"] or sliderapi["Custom"]) and downloadVapeAsset("flavaassets/ColorSlider2.png") or downloadVapeAsset("flavaassets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and downloadVapeAsset("flavaassets/RainbowIcon2.png") or downloadVapeAsset("flavaassets/RainbowIcon1.png"))
	...
	GuiLibrary["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = downloadVapeAsset("flavaassets/PinButton.png")
		...
		optionsbutton.Image = downloadVapeAsset("flavaassets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = downloadVapeAsset("flavaassets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = downloadVapeAsset("flavaassets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = downloadVapeAsset((argstable["Name"] == "ProfilesList" and "flavaassets/TextBoxBKG2.png" or "flavaassets/TextBoxBKG.png"))
				...
				addbutton.Image = downloadVapeAsset("flavaassets/AddItem.png")
				...
				textGuiLibrary["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textGuiLibrary["ObjectList"]) do
						...
						deletebutton.Image = downloadVapeAsset("flavaassets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = downloadVapeAsset("flavaassets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = downloadVapeAsset("flavaassets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	GuiLibrary["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = downloadVapeAsset("flavaassets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = downloadVapeAsset("flavaassets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = downloadVapeAsset("flavaassets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = downloadVapeAsset("flavaassets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = downloadVapeAsset("flavaassets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = downloadVapeAsset("flavaassets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = downloadVapeAsset("flavaassets/SliderArrow1.png")
	...
	GuiLibrary["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = downloadVapeAsset("flavaassets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, textService:GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = downloadVapeAsset("flavaassets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = downloadVapeAsset("flavaassets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = downloadVapeAsset("flavaassets/HoverArrow.png")
			end)
	...
	GuiLibrary["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = downloadVapeAsset("flavaassets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = downloadVapeAsset("flavaassets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = downloadVapeAsset(customicon and "flava"..customicon or "flavaassets/InfoNotification.png")
