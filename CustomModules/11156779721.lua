...
repeat
	...
	if tabcount >= 4 or shared.FlavaExecuted == nil then break end
	task.wait(1)
until tabcount >= 4 or shared.FlavaExecuted == nil
...
if not shared.Flavahooked then
	shared.Flavahooked = true
	local tab = {31, 14, 1}
